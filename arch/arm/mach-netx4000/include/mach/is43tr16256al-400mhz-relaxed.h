...
#define               DENALI_CTL_06_DATA 0x00013880 // TRST_PWRON:RW:0:32:=0x00013880
#define               DENALI_CTL_07_DATA 0x00030d40 // CKE_INACTIVE:RW:0:32:=0x00030d40
#define               DENALI_CTL_08_DATA 0x00000000 // TCPD:RW:8:16:=0x0000 INITAREF:RW:0:4:=0x00
#define               DENALI_CTL_09_DATA 0x0c000200 // CASLAT_LIN:RW:24:6:=0x0c NO_CMD_INIT:RW:16:1:=0x00 TDLL:RW:0:16:=0x0200
#define               DENALI_CTL_10_DATA 0x04040005 // TCCD:RW:24:5:=0x04 TBST_INT_INTERVAL:RW:16:3:=0x04 ADDITIVE_LAT:RW:8:5:=0x00 WRLAT:RW:0:5:=0x05
#define               DENALI_CTL_11_DATA 0x040e1404 // TWTR:RW:24:6:=0x04 TRAS_MIN:RW:16:8:=0x0e TRC:RW:8:8:=0x14 TRRD:RW:0:8:=0x04
#define               DENALI_CTL_12_DATA 0x04041006 // TMRD:RW:24:5:=0x04 TRTP:RW:16:4:=0x04 TFAW:RW:8:8:=0x10 TRP:RW:0:8:=0x06
#define               DENALI_CTL_13_DATA 0x006db00c // TRAS_MAX:RW:8:17:=0x006db0 TMOD:RW:0:8:=0x0c
#define               DENALI_CTL_14_DATA 0x06000503 // TRCD:RW:24:8:=0x06 WRITEINTERP:RW:16:1:=0x00 TCKESR:RW:8:8:=0x05 TCKE:RW:0:3:=0x03
#define               DENALI_CTL_15_DATA 0x01000006 // CONCURRENTAP:RW:24:1:=0x01 AP:RW:16:1:=0x00 TWR:RW:0:6:=0x06
#define               DENALI_CTL_16_DATA 0x06030c01 // TRP_AB:RW:24:8:=0x06 BSTLEN:RW_D:16:3:=0x03 TDAL:RW:8:6:=0x0c TRAS_LOCKOUT:RW:0:1:=0x01
...
#define               DENALI_CTL_19_DATA 0x0c280068 // TREF:RW:16:14:=0x0c28 TRFC:RW:0:10:=0x0068
#define               DENALI_CTL_20_DATA 0x00000000 //
#define               DENALI_CTL_21_DATA 0x000a0003 // TXPDLL:RW:16:16:=0x000a TPDEX:RW:0:16:=0x0003
#define               DENALI_CTL_22_DATA 0x00000000 // TXARDS:RW:16:16:=0x0000 TXARD:RW:0:16:=0x0000
#define               DENALI_CTL_23_DATA 0x006c0200 // TXSNR:RW:16:16:=0x006c TXSR:RW:0:16:=0x0200
...
#define               DENALI_CTL_25_DATA 0x00050500 // LP_CMD:WR:24:8:=0x00 CKSRX:RW:16:8:=0x05 CKSRE:RW:8:8:=0x05 LOWPOWER_REFRESH_ENABLE:RW:0:1:=0x00
...
#define               DENALI_CTL_32_DATA 0x00460420 // MR1_DATA_0:RW:16:15:=0x0046 MR0_DATA_0:RW:0:15:=0x0420
#define               DENALI_CTL_33_DATA 0x00000000 // MRSINGLE_DATA_0:RW:16:15:=0x0000 MR2_DATA_0:RW:0:15:=0x0000
...
#define               DENALI_CTL_70_DATA 0x01000604 // ODT_EN:RW:24:1:=0x01 TODTH_WR:RW:8:4:=0x06 TODTL_2CMD:RW:0:5:=0x04
...
#define               DENALI_CTL_88_DATA 0x00012121 // RDLVL_GATE_DELAY_0:RW+:16:16:=0x0001 RDLVL_DELAY_0:RW:0:16:=0x2121
...
#define               DENALI_CTL_91_DATA 0x00212100 // RDLVL_DELAY_1:RW:8:16:=0x2121 RDLVL_OFFSET_DIR_1:RW:0:1:=0x00
...
#define               DENALI_CTL_95_DATA 0x00012121 // RDLVL_GATE_DELAY_2:RW+:16:16:=0x0001 RDLVL_DELAY_2:RW:0:16:=0x2121
...
#define               DENALI_CTL_98_DATA 0x00212100 // RDLVL_DELAY_3:RW:8:16:=0x2121 RDLVL_OFFSET_DIR_3:RW:0:1:=0x00
...
#define              DENALI_CTL_102_DATA 0x00012121 // RDLVL_GATE_DELAY_4:RW+:16:16:=0x0001 RDLVL_DELAY_4:RW:0:16:=0x2121
...
#define              DENALI_CTL_120_DATA 0x00185000 // TDFI_CTRLUPD_MAX:RW:8:14:=0x1850 TDFI_CTRLUPD_MIN:RD:0:4:=0x00
...
#define              DENALI_CTL_123_DATA 0x00001850 // TDFI_PHYUPD_RESP:RW:0:14:=0x1850
#define              DENALI_CTL_124_DATA 0x00007990 // TDFI_CTRLUPD_INTERVAL:RW:0:32:=0x00007990
#define              DENALI_CTL_125_DATA 0x00020605 // TDFI_DRAM_CLK_DISABLE:RW:24:4:=0x00 TDFI_CTRL_DELAY:RW_D:16:4:=0x02 WRLAT_ADJ:RW:8:6:=0x06 RDLAT_ADJ:RW:0:6:=0x05
...
#define              DENALI_CTL_131_DATA 0x00ffff1e // RDLVL_MAX_DELAY:RW:8:16:=0xffff TDFI_RDLVL_RESPLAT:RW:0:8:=0x1e
