...
void ddr400_init(void) {
	...
	*RAP_SysCtrl |= 0x40; //enable ddr clock manager
	RAP_SysCtrl = (volatile uint32_t *)0xf800004c;
	*RAP_SysCtrl |= 0x40;
	...
	DDRCTRL_DENALI_CTL(29)  =  DENALI_CTL_29_DATA ;		// write MR register
	...
	// default
	// ReadOnly // DDRCTRL_DENALI_CTL(143)
	// ReadOnly // DDRCTRL_DENALI_CTL(144)
	// ReadOnly // DDRCTRL_DENALI_CTL(145)
	// ReadOnly // DDRCTRL_DENALI_CTL(146)
	// ReadOnly // DDRCTRL_DENALI_CTL(147)
	// ReadOnly // DDRCTRL_DENALI_CTL(148)
	// ReadOnly // DDRCTRL_DENALI_CTL(149)
	// ReadOnly // DDRCTRL_DENALI_CTL(150)
	// ReadOnly // DDRCTRL_DENALI_CTL(151)
	// ReadOnly // DDRCTRL_DENALI_CTL(152)
	// ReadOnly // DDRCTRL_DENALI_CTL(153)
	...
	PHYCTRL_CTL(7) = 0x1E060707;//(0x7 << SRT_NX4000_DDR_PHY_OUTCTRL_CKOBUFEN) | (0x2 << SRT_NX4000_DDR_PHY_OUTCTRL_MBL) | (0x9 << SRT_NX4000_DDR_PHY_OUTCTRL_MRL) | (0x7 << SRT_NX4000_DDR_PHY_OUTCTRL_MWL) | MSK_NX4000_DDR_PHY_OUTCTRL_RESETBOE | MSK_NX4000_DDR_PHY_OUTCTRL_CKEODTOE | MSK_NX4000_DDR_PHY_OUTCTRL_ADCMDOE;

//FIXME: Because I don't know why the IRQ mask register should be set, I commented out (FM).
//	DDRCTRL_DENALI_CTL(63)  = 0x3FFF87;   // INT MASK
